...
def diagnoseToAs(ToAs, outputFile='ToADiagnosticsPlot'):
    ...
    #
    fig.update_layout(height=1600, width=1600, title_text="ToA properties for file "+ToAs, showlegend=False, font=dict(size=14))
    #
    fig.show()
...
if __name__ == '__main__':
    ...
    parser.add_argument("-of","--outputFile", help="name of output ToA diagnostics file (default = ToADiagnosticsPlot(.html))", type=str, default='ToADiagnosticsPlot')
